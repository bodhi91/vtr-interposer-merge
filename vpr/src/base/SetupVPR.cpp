...
static void SetupInterposerOpts(const t_options& Options,
                                t_interposer_opts* InterposerOpts);
#endif
...
#ifdef INTERPOSER_BASED_ARCHITECTURE
    SetupInterposerOpts(*options, &vpr_setup->InterposerOpts);
#endif
...
static void SetupInterposerOpts(const t_options& Options,
                                t_interposer_opts* InterposerOpts) {
    InterposerOpts->pre_pack_only = Options.pre_pack_only;
    InterposerOpts->percent_wires_cut = Options.percent_wires_cut;
    InterposerOpts->num_cuts = Options.num_cuts;
    InterposerOpts->delay_increase = Options.delay_increase;
    InterposerOpts->placer_cost_constant = Options.placer_cost_constant;
    InterposerOpts->constant_type = Options.constant_type;
    InterposerOpts->allow_chanx_interposer_connections = Options.allow_chanx_interposer_connections;
    InterposerOpts->transfer_interposer_fanins = Options.transfer_interposer_fanins;
    InterposerOpts->allow_additional_interposer_fanins = Options.allow_additional_interposer_fanins;
    InterposerOpts->pct_of_interposer_nodes_each_chany_can_drive = Options.pct_of_interposer_nodes_each_chany_can_drive;
    InterposerOpts->allow_interposer_opin_to_wire_fanouts = Options.transfer_interposer_fanouts;
    InterposerOpts->allow_interposer_wire_to_ipin_fanins = Options.allow_additional_interposer_fanouts;
}
#endif
