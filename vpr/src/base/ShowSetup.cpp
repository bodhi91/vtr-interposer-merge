...
static void ShowInterposerOpts(const t_interposer_opts& InterposerOpts);
#endif
...
#ifdef INTERPOSER_BASED_ARCHITECTURE
    ShowInterposerOpts(vpr_setup.InterposerOpts);
#endif
}
...
static void ShowNocOpts(const t_noc_opts& NocOpts) {
    ...
    VTR_LOG("NocOpts.noc_placement_file_name: %s\n", NocOpts.noc_placement_file_name.c_str());
    VTR_LOG("\n");
}

#ifdef INTERPOSER_BASED_ARCHITECTURE
static void ShowInterposerOpts(const t_interposer_opts& InterposerOpts) {
    VTR_LOG("InterposerOpts.pre_pack_only: %s\n", InterposerOpts.pre_pack_only ? "true" : "false");
    VTR_LOG("InterposerOpts.percent_wires_cut: %d\n", InterposerOpts.percent_wires_cut);
    VTR_LOG("InterposerOpts.num_cuts: %d\n", InterposerOpts.num_cuts);
    VTR_LOG("InterposerOpts.delay_increase: %d\n", InterposerOpts.delay_increase);
    VTR_LOG("InterposerOpts.placer_cost_constant: %f\n", InterposerOpts.placer_cost_constant);
    VTR_LOG("InterposerOpts.constant_type: %d\n", InterposerOpts.constant_type);
    VTR_LOG("InterposerOpts.allow_chanx_interposer_connections: %s\n", InterposerOpts.allow_chanx_interposer_connections ? "true" : "false");
    VTR_LOG("InterposerOpts.transfer_interposer_fanins: %s\n", InterposerOpts.transfer_interposer_fanins ? "true" : "false");
    VTR_LOG("InterposerOpts.allow_additional_interposer_fanins: %s\n", InterposerOpts.allow_additional_interposer_fanins ? "true" : "false");
    VTR_LOG("InterposerOpts.pct_of_interposer_nodes_each_chany_can_drive: %d\n", InterposerOpts.pct_of_interposer_nodes_each_chany_can_drive);
    VTR_LOG("InterposerOpts.allow_interposer_opin_to_wire_fanouts: %s\n", InterposerOpts.allow_interposer_opin_to_wire_fanouts ? "true" : "false");
    VTR_LOG("InterposerOpts.allow_interposer_wire_to_ipin_fanins: %s\n", InterposerOpts.allow_interposer_wire_to_ipin_fanins ? "true" : "false");
