...
struct t_options {
    ...
    /* Interposer Architecture Options */
    argparse::ArgValue<bool> pre_pack_only;
    argparse::ArgValue<int> percent_wires_cut;
    argparse::ArgValue<int> num_cuts;
    argparse::ArgValue<int> delay_increase;
    argparse::ArgValue<float> placer_cost_constant;
    argparse::ArgValue<int> constant_type;
    argparse::ArgValue<bool> allow_chanx_interposer_connections;
    argparse::ArgValue<bool> transfer_interposer_fanins;
    argparse::ArgValue<bool> allow_additional_interposer_fanins;
    argparse::ArgValue<int> pct_of_interposer_nodes_each_chany_can_drive;
    argparse::ArgValue<bool> transfer_interposer_fanouts;
    argparse::ArgValue<bool> allow_additional_interposer_fanouts;
    argparse::ArgValue<int> pct_of_chany_wires_an_interposer_node_can_drive;
    argparse::ArgValue<bool> allow_bidir_interposer_wires;
#endif
